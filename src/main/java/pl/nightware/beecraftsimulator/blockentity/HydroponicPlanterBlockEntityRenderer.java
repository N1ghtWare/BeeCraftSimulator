...
public class HydroponicPlanterBlockEntityRenderer implements BlockEntityRenderer<HydroponicPlanterBlockEntity>
{
    ...
    public HydroponicPlanterBlockEntityRenderer(BlockEntityRendererProvider.Context _context)
    {
        this.context = _context;
    }
    @Override
    public void render(HydroponicPlanterBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay)
    {
        ...
        poseStack.pushPose();
        poseStack.translate(0.5, 1.7 + moveUpRatio + additionalYFix, 0.5);
