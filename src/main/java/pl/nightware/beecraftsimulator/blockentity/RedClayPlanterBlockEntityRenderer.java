...
public class RedClayPlanterBlockEntityRenderer implements BlockEntityRenderer<RedClayPlanterBlockEntity>
{
    ...
    public RedClayPlanterBlockEntityRenderer(BlockEntityRendererProvider.Context _context)
    {
        this.context = _context;
    }
    @Override
    public void render(RedClayPlanterBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay)
    {
