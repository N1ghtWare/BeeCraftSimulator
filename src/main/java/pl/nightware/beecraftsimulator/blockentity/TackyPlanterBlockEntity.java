...
public class TackyPlanterBlockEntity extends BlockEntity
{
    private int ticksOfGrowth = 0;
    public int ticksRequiredForFullGrowth = 100;
    public float cabbageScaleMultiplier = 1f;
    public TackyPlanterBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntitiesInit.TACKY_PLANTER_ENTITY.get(), pPos, pBlockState);
    }
