...
public class BlueClayPlanterBlockEntity extends BlockEntity
{
    private int ticksOfGrowth = 0;
    public int ticksRequiredForFullGrowth = 100;
    public float cabbageScaleMultiplier = 1f;
    public BlueClayPlanterBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntitiesInit.BLUE_CLAY_PLANTER_ENTITY.get(), pPos, pBlockState);
    }
