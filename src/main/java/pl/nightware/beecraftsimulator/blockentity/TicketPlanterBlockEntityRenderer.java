...
public class TicketPlanterBlockEntityRenderer implements BlockEntityRenderer<TicketPlanterBlockEntity>
{
    ...
    public TicketPlanterBlockEntityRenderer(BlockEntityRendererProvider.Context _context)
    {
        this.context = _context;
    }
    @Override
    public void render(TicketPlanterBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay)
    {
