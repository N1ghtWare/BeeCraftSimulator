...
public class TackyPlanterBlockEntityRenderer implements BlockEntityRenderer<TackyPlanterBlockEntity>
{
    ...
    public TackyPlanterBlockEntityRenderer(BlockEntityRendererProvider.Context _context)
    {
        this.context = _context;
    }
    @Override
    public void render(TackyPlanterBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay)
    {
        ...
        poseStack.pushPose();
        poseStack.translate(0.5, 1.0 + moveUpRatio + additionalYFix, 0.5);
