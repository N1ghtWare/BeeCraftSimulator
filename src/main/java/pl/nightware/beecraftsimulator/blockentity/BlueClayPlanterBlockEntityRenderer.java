...
public class BlueClayPlanterBlockEntityRenderer implements BlockEntityRenderer<BlueClayPlanterBlockEntity>
{
    ...
    public BlueClayPlanterBlockEntityRenderer(BlockEntityRendererProvider.Context _context)
    {
        this.context = _context;
    }
    @Override
    public void render(BlueClayPlanterBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay)
    {
