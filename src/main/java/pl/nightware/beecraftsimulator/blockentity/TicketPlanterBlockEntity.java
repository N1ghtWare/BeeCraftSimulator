...
public class TicketPlanterBlockEntity extends BlockEntity
{
    private int ticksOfGrowth = 0;
    public int ticksRequiredForFullGrowth = 100;
    public float cabbageScaleMultiplier = 1f;
    public TicketPlanterBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntitiesInit.TICKET_PLANTER_ENTITY.get(), pPos, pBlockState);
    }
