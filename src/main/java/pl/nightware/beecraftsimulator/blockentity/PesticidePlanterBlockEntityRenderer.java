...
public class PesticidePlanterBlockEntityRenderer implements BlockEntityRenderer<PesticidePlanterBlockEntity>
{
    ...
    public PesticidePlanterBlockEntityRenderer(BlockEntityRendererProvider.Context _context)
    {
        this.context = _context;
    }
    @Override
    public void render(PesticidePlanterBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource multiBufferSource, int packedLight, int packedOverlay)
    {
        ...
        poseStack.pushPose();
        poseStack.translate(0.5, 1.5 + moveUpRatio + additionalYFix, 0.5);
