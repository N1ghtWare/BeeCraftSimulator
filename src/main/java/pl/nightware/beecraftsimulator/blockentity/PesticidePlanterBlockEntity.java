...
public class PesticidePlanterBlockEntity extends BlockEntity
{
    private int ticksOfGrowth = 0;
    public int ticksRequiredForFullGrowth = 100;
    public float cabbageScaleMultiplier = 1f;
    public PesticidePlanterBlockEntity(BlockPos pPos, BlockState pBlockState)
    {
        super(ModBlockEntitiesInit.PESTICIDE_PLANTER_ENTITY.get(), pPos, pBlockState);
    }
